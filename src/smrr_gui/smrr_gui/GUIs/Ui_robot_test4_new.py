...
"}")
        ...
        self.mainstack.setGeometry(QtCore.QRect(40, 140, 701, 241))
...
"}")
        ...
        self.btn_crwnav_run.setGeometry(QtCore.QRect(250, 20, 130, 41))
...
"    outline: none;")
        ...
        self.btn_crowdnav_ = QtWidgets.QPushButton(self.CrowdNav)
        self.btn_crowdnav_.setGeometry(QtCore.QRect(70, 110, 101, 61))
        self.btn_crowdnav_.setStyleSheet("font-size:20px")
        self.btn_crowdnav_.setObjectName("btn_crowdnav_")
        self.pushButton_3 = QtWidgets.QPushButton(self.CrowdNav)
        self.pushButton_3.setGeometry(QtCore.QRect(500, 100, 101, 71))
...
"}")
        ...
        self.btn_dock.setGeometry(QtCore.QRect(260, 100, 171, 81))
        font = QtGui.QFont()
        font.setPointSize(-1)
        font.setBold(True)
        font.setItalic(False)
        font.setWeight(75)
        self.btn_dock.setFont(font)
        self.btn_dock.setStyleSheet("font-size: 20px")
...
"")
        ...
        self.Notifications.setGeometry(QtCore.QRect(70, 30, 691, 51))
        font = QtGui.QFont()
        font.setFamily("Ubuntu")
        font.setPointSize(-1)
        font.setBold(True)
        ...
        self.frame_2.setGeometry(QtCore.QRect(40, 380, 691, 81))
...
"}")
        ...
        self.btn_crowdnav.setMaximumSize(QtCore.QSize(250, 50))
        ...
        self.btn_multifloor.setMaximumSize(QtCore.QSize(250, 50))
        ...
        self.btn_arm.setMaximumSize(QtCore.QSize(250, 50))
...
"font-weight: bold;")
        ...
        self.Homebtn.setGeometry(QtCore.QRect(10, 10, 40, 40))
...
"}")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.btn_crowdnav_.setText(_translate("MainWindow", "Start"))
        ...
        self.pushButton_2.setText(_translate("MainWindow", "Docking"))
