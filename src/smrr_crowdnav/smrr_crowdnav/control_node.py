...
class CrowdNavMPCNode(Node):
    def __init__(self):
        ...
        self.create_subscription(Entities, '/laser_data_array_kf', self.human_position_callback, 10)
        self.create_subscription(Entities, '/vel_kf', self.human_velocity_callback, 10)
